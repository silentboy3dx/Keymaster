...
So hey 3DX chatter!, so you are the proud owner of  stream deck and you want to be just like me and 
...
* `SendKeys.csproj`: The C# project file used to build the plugin
...
My name is Silentboy you might know me from the Sin club (say hi). Of Course this is not my real name but i dont want to reveal my real name here since not everyone in Sin likes me (Shoutout to Clittywinks). Just say hi when you see me if you will use the plugin and i will be happy (its free after all).
